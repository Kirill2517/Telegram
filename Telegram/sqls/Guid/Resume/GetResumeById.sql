select Resume.idResume Id, DataUser.email Owner, Speciality.name Speciality, workExperience, desiredSalary, Resume.created, Resume.title, description from Resume 
